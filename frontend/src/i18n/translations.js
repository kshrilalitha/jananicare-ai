export const translations = {
  en: {
    ...
    previous: 'Previous', dietType: 'Diet Type', vegetarian: 'Vegetarian', nonVegetarian: 'Non-Vegetarian', vegan: 'Vegan',
    antenatalVisitsSoFar: 'Antenatal Visits So Far', describePreviousComplications: 'Describe Previous Complications',
    currentSupplements: 'Current Supplements', ironSupplements: 'Iron Supplements', folicAcid: 'Folic Acid',
    additionalNotes: 'Additional Notes', listening: 'Listening...', heard: 'Heard:',
    symptomsDetectedAuto: 'Symptoms detected and auto-selected below ✓', voiceDetectedAdditional: 'Voice-Detected Additional Symptoms:',
    noSymptomsSelected: 'No symptoms selected', nextStepArrow: 'Next Step →', previousArrow: '← Previous',
    reviewBasicInfo: 'Basic Information', reviewVitals: 'Health Vitals', reviewSymptoms: 'Symptoms', reviewReviewSubmit: 'Review & Submit',
    fatigue: 'Fatigue / Tiredness', dizziness: 'Dizziness', swelling: 'Swelling (hands/feet/face)', headache: 'Headache',
    bleeding: 'Vaginal Bleeding', nausea: 'Nausea', vomiting: 'Vomiting', abdominal_pain: 'Abdominal Pain',
    reduced_fetal_movement: 'Reduced Fetal Movement', blurred_vision: 'Blurred Vision', chest_pain: 'Chest Pain',
    shortness_of_breath: 'Shortness of Breath', fever: 'Fever', none: 'No Symptoms',
    // ASHA Dashboard
    ...
    enableSound: 'Enable Sound', openInGoogleMaps: 'Open in Google Maps', patientEmergencyLocation: 'Patient Emergency Location',
    maternityHospitalsPHCs: 'Maternity Hospitals & PHCs', searchNear: 'Search Near:', myLocation: 'My Location', myPatients: 'My Patients',
    // Patient Detail
    ...
    highRiskSubtext: 'Your health data indicates a high-risk pregnancy. Please seek medical help immediately.',
    medicalConsultationRecommended: 'Medical Consultation Recommended',
    mediumRiskSubtext: 'Your health data shows some concerning factors. Please schedule a doctor visit soon.',
    pregnancyAppearsHealthy: 'Pregnancy Appears Healthy',
    lowRiskSubtext: 'Your health data looks good! Continue your regular antenatal care routine.',
    emergencyActionRequired: 'EMERGENCY ACTION REQUIRED',
    emergencyActionDesc: 'Go to the nearest Primary Health Centre or hospital immediately. Do not delay.',
    consultationTimeframeLabel: 'Consultation Timeframe', doctorVisitRequiredLabel: 'Doctor Visit Required',
    aiConfidenceLabel: 'AI Confidence', predictionAccuracy: 'prediction accuracy', urgencyLevelLabel: 'Urgency Level',
    riskFactorsIdentified: 'Risk Factors Identified', aiRecommendations: 'AI Recommendations', preventiveCareGuidance: 'Preventive Care Guidance',
    call108: 'Call 108', call112: 'Call 112', callNow: 'Call Now', contactViaApp: 'Contact via app',
    newAssessmentBtn: 'New Assessment', sendEmergencyAlertBtn: 'Send Emergency Alert',
    // Language
  ...
  kn: {
    ...
    previous: 'ಹಿಂದಿನ', dietType: 'ಆಹಾರ ಪದ್ಧತಿ', vegetarian: 'ಸಸ್ಯಾಹಾರಿ', nonVegetarian: 'ಮಾಂಸಾಹಾರಿ', vegan: 'ಸಸ್ಯಾಹಾರಿ (ವೇಗನ್)',
    antenatalVisitsSoFar: 'ಇಲ್ಲಿಯವರೆಗಿನ ಗರ್ಭಪೂರ್ವ ಭೇಟಿಗಳು', describePreviousComplications: 'ಹಿಂದಿನ ತೊಂದರೆಗಳನ್ನು ವಿವರಿಸಿ',
    currentSupplements: 'ಪ್ರಸ್ತುತ ಪೂರಕಗಳು', ironSupplements: 'ಕಬ್ಬಿಣದ ಪೂರಕಗಳು', folicAcid: 'ಫೋಲಿಕ್ ಆಸಿಡ್',
    additionalNotes: 'ಹೆಚ್ಚುವರಿ ಟಿಪ್ಪಣಿಗಳು', listening: 'ಆಲಿಸಲಾಗುತ್ತಿದೆ...', heard: 'ಕೇಳಿಸಿದ್ದು:',
    symptomsDetectedAuto: 'ರೋಗಲಕ್ಷಣಗಳನ್ನು ಪತ್ತೆಹಚ್ಚಲಾಗಿದೆ ಮತ್ತು ಕೆಳಗೆ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಆಯ್ಕೆಮಾಡಲಾಗಿದೆ ✓', voiceDetectedAdditional: 'ಧ್ವನಿ-ಪತ್ತೆಹಚ್ಚಿದ ಹೆಚ್ಚುವರಿ ರೋಗಲಕ್ಷಣಗಳು:',
    noSymptomsSelected: 'ಯಾವುದೇ ರೋಗಲಕ್ಷಣಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿಲ್ಲ', nextStepArrow: 'ಮುಂದಿನ ಹಂತ →', previousArrow: '← ಹಿಂದಿನ',
    reviewBasicInfo: 'ಮೂಲ ಮಾಹಿತಿ', reviewVitals: 'ಆರೋಗ್ಯ ಮಾಪನಗಳು', reviewSymptoms: 'ರೋಗಲಕ್ಷಣಗಳು', reviewReviewSubmit: 'ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಸಲ್ಲಿಸಿ',
    fatigue: 'ಆಯಾಸ / ದಣಿವು', dizziness: 'ತಲೆತಿರುಗುವಿಕೆ', swelling: 'ಊತ (ಕೈ/ಕಾಲು/ಮುಖ)', headache: 'ತಲೆನೋವು',
    bleeding: 'ಯೋನಿ ರಕ್ತಸ್ರಾವ', nausea: 'ವಾಕರಿಕೆ', vomiting: 'ವಾಂತಿ', abdominal_pain: 'ಹೊಟ್ಟೆ ನೋವು',
    reduced_fetal_movement: 'ಕಡಿಮೆಯಾದ ಭ್ರೂಣದ ಚಲನೆ', blurred_vision: 'ಮಸುಕಾದ ದೃಷ್ಟಿ', chest_pain: 'ಎದೆ ನೋವು',
    shortness_of_breath: 'ಉಸಿರಾಟದ ತೊಂದರೆ', fever: 'ಜ್ವರ', none: 'ರೋಗಲಕ್ಷಣಗಳಿಲ್ಲ',
    // ASHA Dashboard
    ...
    enableSound: 'ಧ್ವನಿ ಸಕ್ರಿಯಗೊಳಿಸಿ', openInGoogleMaps: 'ಗೂಗಲ್ ಮ್ಯಾಪ್ಸ್‌ನಲ್ಲಿ ತೆರೆಯಿರಿ', patientEmergencyLocation: 'ರೋಗಿಯ ತುರ್ತು ಸ್ಥಳ',
    maternityHospitalsPHCs: 'ಹೆರಿಗೆ ಆಸ್ಪತ್ರೆಗಳು ಮತ್ತು PHC ಗಳು', searchNear: 'ಹತ್ತಿರದಲ್ಲಿ ಹುಡುಕಿ:', myLocation: 'ನನ್ನ ಸ್ಥಳ', myPatients: 'ನನ್ನ ರೋಗಿಗಳು',
    // Patient Detail
    ...
    // Risk Result Page
    immediateMedicalAttention: 'ತಕ್ಷಣ ವೈದ್ಯಕೀಯ ಗಮನ ಅಗತ್ಯವಿದೆ',
    highRiskSubtext: 'ನಿಮ್ಮ ಆರೋಗ್ಯ ಮಾಹಿತಿಯು ಹೆಚ್ಚಿನ-ಅಪಾಯದ ಗರ್ಭಧಾರಣೆಯನ್ನು ಸೂಚಿಸುತ್ತದೆ. ದಯವಿಟ್ಟು ತಕ್ಷಣ ವೈದ್ಯಕೀಯ ಸಹಾಯ ಪಡೆಯಿರಿ.',
    medicalConsultationRecommended: 'ವೈದ್ಯಕೀಯ ಸಮಾಲೋಚನೆ ಶಿಫಾರಸು ಮಾಡಲಾಗಿದೆ',
    mediumRiskSubtext: 'ನಿಮ್ಮ ಆರೋಗ್ಯ ಮಾಹಿತಿಯು ಕೆಲವು ಕಾಳಜಿಯ ಅಂಶಗಳನ್ನು ತೋರಿಸುತ್ತದೆ. ದಯವಿಟ್ಟು ಶೀಘ್ರದಲ್ಲೇ ವೈದ್ಯರ ಭೇಟಿಯನ್ನು ನಿಗದಿಪಡಿಸಿ.',
    pregnancyAppearsHealthy: 'ಗರ್ಭಧಾರಣೆ ಆರೋಗ್ಯಕರವಾಗಿದೆ ಎಂದು ತೋರುತ್ತದೆ',
    lowRiskSubtext: 'ನಿಮ್ಮ ಆರೋಗ್ಯ ಮಾಹಿತಿ ಉತ್ತಮವಾಗಿದೆ! ನಿಮ್ಮ ನಿಯಮಿತ ಗರ್ಭಪೂರ್ವ ಆರೈಕೆ ದಿನಚರಿಯನ್ನು ಮುಂದುವರಿಸಿ.',
    emergencyActionRequired: 'ತುರ್ತು ಕ್ರಮ ಅಗತ್ಯವಿದೆ',
    emergencyActionDesc: 'ತಕ್ಷಣವೇ ಹತ್ತಿರದ ಪ್ರಾಥಮಿಕ ಆರೋಗ್ಯ ಕೇಂದ್ರ ಅಥವಾ ಆಸ್ಪತ್ರೆಗೆ ಹೋಗಿ. ವಿಳಂಬ ಮಾಡಬೇಡಿ.',
    consultationTimeframeLabel: 'ಸಮಾಲೋಚನೆ ಸಮಯ', doctorVisitRequiredLabel: 'ವೈದ್ಯರ ಭೇಟಿ ಅಗತ್ಯವಿದೆ',
    aiConfidenceLabel: 'AI ವಿಶ್ವಾಸ', predictionAccuracy: 'ಮುನ್ಸೂಚನೆ ನಿಖರತೆ', urgencyLevelLabel: 'ತುರ್ತು ಮಟ್ಟ',
    riskFactorsIdentified: 'ಗುರುತಿಸಲಾದ ಅಪಾಯದ ಅಂಶಗಳು', aiRecommendations: 'AI ಶಿಫಾರಸುಗಳು', preventiveCareGuidance: 'ತಡೆಗಟ್ಟುವ ಆರೈಕೆ ಮಾರ್ಗದರ್ಶನ',
    call108: '108 ಗೆ ಕರೆ ಮಾಡಿ', call112: '112 ಗೆ ಕರೆ ಮಾಡಿ', callNow: 'ಈಗ ಕರೆ ಮಾಡಿ', contactViaApp: 'ಅಪ್ಲಿಕೇಶನ್ ಮೂಲಕ ಸಂಪರ್ಕಿಸಿ',
    newAssessmentBtn: 'ಹೊಸ ಮೌಲ್ಯಮಾಪನ', sendEmergencyAlertBtn: 'ತುರ್ತು ಎಚ್ಚರಿಕೆ ಕಳುಹಿಸಿ',
    // Language
